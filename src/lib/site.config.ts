...
export const siteConfig: SiteConfig = {
  ...
  description:
    'Stillscape licenses seamless 4K forest-bathing (shinrin-yoku) video loops — living forest scenery for spas, studios, bars, lobbies, and waiting rooms. Turn dead TVs and blank walls into calm, moving forest atmosphere.',
  shortDescription:
    'Seamless 4K forest-bathing video loops, licensed for commercial spaces. Living forest scenery for calm rooms.',
  ...
  keywords: [
    ...
    'shinrin-yoku loop',
    'forest video loop',
    'ambient forest video',
    'digital signage forest',
    'looping background video for spa',
    '4K forest loop',
